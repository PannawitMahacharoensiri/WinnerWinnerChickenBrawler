...
class Attack(pygame.sprite.Sprite):
    ...
    def update(self, frame, atk_group):
        ...
        # Not has single direction YET need to WORK on it
    ...
    def set_position(self, mouse_position):
        ...
        # self.rect.x = self.maker.rect.center[0] + Attack.atk_direction[direction][0]
        # self.rect.y = self.maker.rect.center[1] + Attack.atk_direction[direction][1]

        ## WORKING
        # self.rect.center = (self.maker.rect.center[0] + Attack.atk_direction[direction][0],
        #                     self.maker.rect.center[1] + Attack.atk_direction[direction][1])
