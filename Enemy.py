...
class Boss2(Enemy):
    ...
    def __init__(self, position, game, name):
        ...
        self.charge = {"try_to_run":0, "bounce":0, "stunt":0}
    ...
    def behaviour(self, frame, ms_per_loop):
        ...
        elif self.action == "run" and length <= 80 * self.game.screen_scale and self.cooldown["spike"] == 0:
            self.action = "spike"

        elif length > 150 * self.game.screen_scale and self.action == "run":
